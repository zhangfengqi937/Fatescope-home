...
export default function HeroAurora() {
  return (
    <section
      ...
      "
    >
      {/* Aurora 背景：黄绿 + 金色（更柔，热区外推） */}
      <div className="absolute inset-0 -z-10">
        <div
          className="aurora-blob aurora-anim-a absolute -top-32 -left-28 w-[56rem] h-[22rem]"
          style={{
            background:
              'radial-gradient(60rem 20rem at 50% 50%, rgba(250,204,21,0.30), transparent 60%)', // amber-400/30
          }}
        />
        <div
          ...
          style={{
            background:
              'radial-gradient(55rem 18rem at 50% 50%, rgba(34,197,94,0.24), transparent 60%)', // emerald-500/24
          }}
        />
        <div
          ...
          style={{
            background:
              'radial-gradient(60rem 22rem at 50% 50%, rgba(132,204,22,0.20), transparent 60%)', // lime-500/20
          }}
        />
      </div>
