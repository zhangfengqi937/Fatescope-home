    ...
    >
      ...
      >
        ...
        <p className="mt-4 text-lg md:text-xl text-slate-700 max-w-3xl zh-leading">
          Photography · Writing · Fatescope App — Cloud + AI + Independent Astrology algorithms for kinder guidance.
        </p>

        {/* 标签按钮（chip） */}
        <div className="mt-5 flex flex-wrap gap-2 text-sm md:text-base">
          <Button as="span" variant="tag" size="sm">Independent Astrology Engine</Button>
