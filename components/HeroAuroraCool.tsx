    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        <div
          ...
          style={{
            background:
              'radial-gradient(60rem 20rem at 50% 50%, rgba(59,130,246,0.30), transparent 60%)', // sky-500/30
          }}
        />
        <div
          ...
          style={{
            background:
              'radial-gradient(55rem 18rem at 50% 50%, rgba(34,211,238,0.24), transparent 60%)', // cyan-400/24
          }}
        />
        <div
          ...
          style={{
            background:
              'radial-gradient(60rem 22rem at 50% 50%, rgba(99,102,241,0.22), transparent 60%)', // indigo-500/22
          }}
        />
      </div>
      ...
      {/* 文案区（与中文页一致） */}
      <div className="relative px-8 md:px-16 py-10 md:py-16">
        ...
        <div className="mt-5 flex flex-wrap gap-2 text-sm md:text-base">
          <span className="px-3 py-1 rounded-full bg-white/70 ring-1 ring-slate-200">Independent engine</span>
          <span className="px-3 py-1 rounded-full bg-white/70 ring-1 ring-slate-200">Cloud + AI</span>
          <span className="px-3 py-1 rounded-full bg-white/70 ring-1 ring-slate-200">Kind guidance</span>
        </div>
